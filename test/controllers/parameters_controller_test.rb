...
class ParametersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create parameter" do
    assert_difference("Parameter.count") do
      post parameters_url, params: { parameter: { from: @parameter.from, k: @parameter.k, m: @parameter.m, n_g: @parameter.n_g, n_s: @parameter.n_s, to: @parameter.to } }
    end
  ...
  test "should update parameter" do
    patch parameter_url(@parameter), params: { parameter: { from: @parameter.from, k: @parameter.k, m: @parameter.m, n_g: @parameter.n_g, n_s: @parameter.n_s, to: @parameter.to } }
